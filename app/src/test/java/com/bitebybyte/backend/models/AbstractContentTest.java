...
public class AbstractContentTest {
    ...
    private final AbstractContent instance = new TestContent(ownerId, content);

    public class TestContent extends AbstractContent {
        public TestContent(String ownerId, String content) {
